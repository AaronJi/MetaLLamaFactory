...
from ...model.model_utils.meta_swiglu import MetaLlamaMLP,MetaSwiGLUDataDrivenActivation,MetaSwiGLUSimpleActivation
...
class CustomSeq2SeqTrainer(Seq2SeqTrainer):
    ...
    def __init__(
        ...
        # 检查可用显示内存并打印显示内存状态
        print(f'Allocated before init: {torch.cuda.memory_allocated() / 1024**2} MB')
        print(f'Cached before init: {torch.cuda.memory_reserved() / 1024**2} MB')
    ...
    def compute_loss(
        ...
        ##TODO Parameter regularization can be added here
        # if self.finetuning_args.finetuning_type == "meta_swiglu" or self.finetuning_args.finetuning_type == "meta_swiglu_simple":
        #     regularization_loss = 0.0
        #     for name, module in model.named_modules():
        #         if "meta_act_fn" in name:
        #             regularization_loss += torch.norm(module.beta)
        #     loss += self.finetuning_args.meta_swiglu_l2_lambda * regularization_loss
