...
class FinetuningArguments(
    ...
    finetuning_type: Literal["lora", "freeze", "full", "meta_swiglu_simple", "meta_swiglu"] = field(
        default="lora",
    ...
    meta_swiglu_l2_lambda: float = field(
        default=0.001,
        metadata={"help": "meta_swiglu_l2_lambda for regularization"},
    )
    meta_hidden_act: Optional[str] = field(
        default=None,
        metadata={"help": "MetaSwiGLU ’s activation"},
    )
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora", "freeze", "full", "meta_swiglu_simple", "meta_swiglu"], "Invalid fine-tuning method."
